set dynamodb.throughput.write.percent=90;
...
CASE
    WHEN web_search1 is NULL THEN '_'
    WHEN web_search1 ='' THEN '_'
    ELSE web_search1 end
    as web_search1,
CASE
    WHEN web_search2 is NULL THEN '_'
    WHEN web_search2 ='' THEN '_'
    ELSE web_search2 end
    as web_search2
